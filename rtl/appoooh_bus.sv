...
module appoooh_bus(
 ...
 input logic [7:0] mem_data,p1,p2,dsw,system,
 ...
 assign mem_write=write_cycle&&!seen&&memory_cycle&&addr>=16'he000;
 ...
 always_ff @(posedge clk) begin
  if(reset)cpu_data<=8'hff;
    ...
    0:cpu_data<=p1;1:cpu_data<=p2;3:cpu_data<=dsw;4:cpu_data<=system;
